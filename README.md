...
* Huge Problem : Control the projectile and the shoot of the bow (impulsion force) 
...
* Huge Problem :
 at first i tried with just a timeline, but not worked at all. 
with angular parameters and a little calculate of sinus on pitch(y) that fine !
